...
struct precomp_instr
{
  ...
  /* 0=not wasm optimized; 1-2=cached; 3=wasm optimized */
  /* recomp_status & 0b01111111 = number of jumps */
  /* recomp_status >> 7 = whether or not this instruction was selected for recompilation */
  char recomp_status; 
};
